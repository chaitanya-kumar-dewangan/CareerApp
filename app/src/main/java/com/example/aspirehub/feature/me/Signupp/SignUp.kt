package com.example.aspirehub.feature.me.Signupp
...
//            OutlinedTextField(value = interest,
//                onValueChange = { interest= it },
//                modifier = Modifier.fillMaxWidth(),
//                label = { Text(text = "Interest") })
//
//            OutlinedTextField(value = clas,
//                onValueChange = { clas = it },
//                modifier = Modifier.fillMaxWidth(),
//                label = { Text(text = "Class") })
            ...
            if (uiState.value == SignUpState.Loading) {
                ...
                Button(
                    onClick = {
                        viewModel.signUp(name, age, phone, interest, clas, email, password)
                    }, modifier = Modifier.fillMaxWidth(),
